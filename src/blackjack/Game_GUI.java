...
public class Game_GUI {
  ...
  public boolean faceDown; // this boolean value will tell the program if we have the card facedown or
                           // faceup.

  JFrame frame; // we create a JFrame.
  GameComponent atmosphereComponent; // Two GameComponents: one for the background images, buttons, and the overall
                                     // atmosphere.
  GameComponent cardComponent; // Other for the cards printing out.

  public Game_GUI(JFrame f) {// with this constructor, we initialize the instant fields accordingly. This
                             // constructor gets a JFrame as a parameter.
  ...
  public void formGame(Card[] deck, Card[] player1hand, Card[] player2hand, Card[] player3hand, Card[] dealerhand) {
    ...
    atmosphereComponent = new GameComponent(Deck, dealerHand, playerHand1, playerHand2, playerHand3); // we initialize
                                                                                                      // the
                                                                                                      // GameComponent
                                                                                                      // that will be
                                                                                                      // the overall
  ...
  // rank of the card (Ace[0], 2[1], 3[2], 4[3], 5[4], 6[5], 7[6], 8[7], 9[8],
  // 10[9], Jack[10], Queen[11], or King[12])
  // value of the card in blackjack (from 1 to 11) (images_value = 10, Aces= 1 or
  // 11
  ...
  public void startGame(Card[] deck, Card[] player1hand, Card[] player2hand, Card[] player3hand, Card[] dealerhand) { // this
                                                                                                                      // method
                                                                                                                      // starts
                                                                                                                      // the
                                                                                                                      // game:
    ...
    cardComponent = new GameComponent(Deck, dealerHand, playerHand1, playerHand2, playerHand3); // we initialize our
                                                                                                // component which
                                                                                                // accepts two card
                                                                                                // arraylists.
